...
mapboxgl.accessToken =
  "pk.eyJ1IjoiZ2FtYWxlbGRpbiIsImEiOiJja3phYXliaDgwbnNsMnVtcXZsejM4MTFjIn0.c6RmMiXJPcaz6ohxEOpUMg"; //Unique token for the map from Mapbox
  ...
  map.on("load", () => {
    ...
    map.on("click", "clusters", (e) => {
      ...
      map.getSource("earthquakes").getClusterExpansionZoom(
        // Data source : Locations list in the Geojson file.
        clusterId,
        (err, zoom) => {
          if (err) return;
